...
RUN_STRINGS = (
    "Dude i heard you are going to create a rom Dont kang our Logo Xd!",
    "Kangers everywhere",
    ...
    "You run, you die.",
    "Jokes on you, Dot os Fags everywhere",
    "You're gonna regret that...",
    "You could also try /kickme, I hear that's fun.",
    "Go bother Dot os fags, no-one here cares.",
    "You can kang, but you can't hide.",
